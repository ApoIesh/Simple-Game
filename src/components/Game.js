...
class Game extends React.Component {
    ...
    componentWillUpdate(nextProps, netxState) {
        if (netxState.selectedIds !== this.state.selectedIds || netxState.remainingSeconds === 0) {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.resetText}>{this.gameStatus}   {this.state.remainingSeconds}</Text> 
            </View>
        );
    }
}
